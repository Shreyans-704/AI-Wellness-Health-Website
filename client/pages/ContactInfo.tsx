          ...
          <div className="bg-blue-50 rounded-xl p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg p-5 shadow-sm">
                {/* Centered Name */}
                <h3 className="text-xl font-semibold text-gray-800 mb-2 text-center">{doctorInfo.name}</h3>
                <p className="text-blue-600 font-medium mb-4 text-center">{doctorInfo.specialty}</p>
              ...
              {/* Hospital Info */}
              <div className="bg-white rounded-lg p-5 shadow-sm">
                <h3 className="text-xl font-semibold text-gray-800 mb-4 text-center">{doctorInfo.hospitalName}</h3>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-5">
                <h3 className="text-lg font-semibold text-red-800 mb-3 flex items-center justify-center">
                ...
                <p className="text-red-600 text-sm text-center">Available 24/7 for medical emergencies</p>
              </div>
